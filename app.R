...
# ---- Notes API config ----
NOTES_API_URL   <- "https://script.google.com/macros/s/AKfycbz_uwyiMbr_Wsj_bQLDJ082wXcgt94bk5HUUONVOy_FFrtnUb0Ikf0x0iIoqDj0FvWP/exec"
NOTES_API_TOKEN <- "cbubaseball"
      ...
      fluidRow(
        ...
        column(
          ...
          div(style = "text-align:right; margin-top:10px;",
              tags$img(src = "CBUlogo.png", height = "80px"))
        )
      )
    },
    sidebarLayout(
            ...
            fluidRow(
              ...
              column(2,
                     div(style = "text-align: right; padding-top: 30px;",
                         tags$img(src = "CBUlogo.png", style = "height: 40px; max-width: 100%;")
                     )
              )
            ),
            hr(),
...
ui <- tagList(
  ...
  tags$head(
    tags$style(HTML("
      /* CBU navbar */
      .navbar-inverse { background-color:#1B365D; border-color:#1B365D; }
      ...
      .navbar-inverse .navbar-nav>li:not(.active)>a:focus { color:#C8A882 !important; background:transparent; }
...
")),
  ...
  tags$style(HTML("
    ...
    #openNote.btn-note {
      background-color:#C8A882;   /* CBU gold */
      border-color:#ffffff;
      color:#fff;
    }
    ...
    #openNote.btn-note:active:focus {
      background-color:#1B365D;   /* CBU navy blue on hover/active */
      border-color:#ffffff;
      color:#fff;
      outline:none;
    }
  ...
  navbarPage(
    title = tagList(
      tags$img(src = "CBUlogo.png", class = "brand-logo", alt = "CBU"),
...
server <- function(input, output, session) {
  ...
  admin_emails <- c("jgaynor@pitchingcoachu.com", "andalvarez@calbaptist.edu", "msilberman@calbaptist.edu")
